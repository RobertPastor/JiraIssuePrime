    ...
    */
    ...
    public void setFieldValue(ApplicationUser currentUser, MutableIssue issue, Field field, Object value, IssueChangeHolder changeHolder) {
        if (fieldManager.isCustomField(field)) {
            ...
            } else if (newValue instanceof ApplicationUser && !(cfType instanceof UserCFType)) {
                newValue = ((ApplicationUser)newValue).getName();
...
//                    issue.setDescription(value.toString());
     ...
     */
    @Deprecated
    private ApplicationUser convertApplicationUserToCrowdEmbeddedUser(ApplicationUser applicationUser){
